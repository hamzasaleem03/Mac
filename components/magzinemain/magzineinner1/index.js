    ...
    <>
      <div className="mx-auto container mt-14">
        ...
        <div className="mt-10 w-full">
          <img className="max-w-[1062px] w-full"
        ...
        <div className="mt-10">
        <p className="text-3xl font-bold raleway text-left text-gray-800">Essentials</p>
        <p className="text-2xl tracking-wide open text-left text-gray-600 mt-6">Telling ya’all how awesome we are We offers style choices that make your outfit of the day look fire.</p>
        <p className="text-2xl tracking-wide open text-left text-gray-600 my-8">Telling ya’all how awesome we are We offers style choices that make your outfit of the day look fire.</p>
        <p className="text-2xl tracking-wide open text-left  text-gray-600">Here is a paragraph telling ya’all how awesome we are We offers style choices that make your outfit of the day look fire. Here is a paragraph telling </p>
        <p className="text-3xl font-bold raleway text-left raleway my-10 text-gray-800">Responsibilities</p>
        <p className="text-2xl tracking-wide text-left open text-gray-600">Here is a paragraph telling ya’all how awesome we are We offers style choices that make your outfit of the day look fire. Here is a paragraph telling ya’all how awesome we are</p>
        </div>
      </div>
    </>
  );
