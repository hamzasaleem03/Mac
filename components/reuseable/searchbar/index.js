  ...
  return (
    <>
      <div className="relative">
        ...
        <img
          className="absolute right-0 -top-10 h-[400px] "
          src={sideimg}
          alt={sideimg}
        />
        <div className="container mt-[140px] mx-auto w-full">
          <p className="md:text-5xl text-4xl font-bold leading-[48px] text-gray-800 mb-6 text-center raleway">
            Ready to Rock Together ?
          </p>
          <p className="text-xl leading-7 text-center text-gray-600 lg:max-w-[842px] w-full mx-auto open">
          ...
          <div className="flex justify-center items-center gap-4 mt-14 md:flex-row flex-col">
            <input
              type="search"
              className="text-base leading-none text-gray-600 p-6 w-96 h-16 bg-gray-100 outline-none open"
